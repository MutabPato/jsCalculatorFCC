let trailingResult=0;
        ...
        function updateDisplay(input){
            ...
            if(display.innerHTML==="0" && operationOptions.indexOf(input) ===-1){
                ...
                if(trailingResult===display.innerHTML){
                    //operand button press twice exception
                ...
                //console.log("decimal skipped,already in number")
        ...
        function clearDisplay(){ onclick="updateDisplay()"
            let display=document.getElementById("display");
            let secondaryDisplay=document.getElementById("secondaryDisplay");
            trailingResult=0;
            display.innerHTML = 0;
        ...
        function calculate(firstNumber,secondNumber,operation){
            ...
            switch(workingOperation){
                ...
                break;
                default:
                //console.log("Calculate switch missed something")
